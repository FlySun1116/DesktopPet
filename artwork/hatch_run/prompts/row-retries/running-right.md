Create Codex pet row `running-right` for `zhangle`: exactly 8 full-body frames in one horizontal strip on flat pure cyan #00FFFF.

Use the attached canonical base for identity and the layout guide only for spacing. Same pet in every frame: Japanese 2D cel-shaded chibi humanoid, 3 heads tall, long straight black hair with soft center-parted wispy bangs, gentle almond eyes, small natural smile, red-and-white polka-dot bow dress with matching large hair bow and white lace boots; preserve facial resemblance and consistent outfit.. Preserve silhouette, face, palette, material, proportions, markings, and props.
